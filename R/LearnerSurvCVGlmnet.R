  ...
  public = list(
    ...
    initialize = function() {
      ps = ps(
        ...
        type.measure = p_fct(default = "deviance", levels = c("deviance", "C"), tags = "train"),
        ...
        s = p_dbl(lower = 0, upper = 1, special_vals = list("lambda.1se", "lambda.min"), default = "lambda.1se", tags = "predict")
      )
