    ...
    initialize = function() {
      ps = ParamSet$new(
        list(
          ...
          ParamFct$new("type.logistic", default = "Newton",
                       levels = c("Newton", "modified.Newton"), tags = "train"),
          ParamFct$new("type.multinomial", default = "ungrouped",
          ...
          ParamDbl$new("s", lower = 0, upper = 1, special_vals = list("lambda.1se", "lambda.min"),
