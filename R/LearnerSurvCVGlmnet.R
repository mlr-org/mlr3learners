...
LearnerSurvCVGlmnet = R6Class("LearnerSurvCVGlmnet",
    ...
    initialize = function() {
      ps = ParamSet$new(
        list(
          ...
          ParamFct$new("type.measure", default = "deviance",
          ...
          ParamFct$new("type.logistic", default = "Newton", levels = c("Newton", "modified.Newton"), tags = "train"),
          ParamFct$new("type.multinomial", default = "ungrouped", levels = c("ungrouped", "grouped"), tags = "train"),
          ...
          ParamDbl$new("s", lower = 0, upper = 1, special_vals = list("lambda.1se", "lambda.min"), default = "lambda.1se", tags = "predict")
        )
      )
  ...
  private = list(
    ...
    .predict = function(task) {
      ...
      mlr3proba::PredictionSurv$new(task = task, lp = lp, crank = lp)
    }
  )
)
