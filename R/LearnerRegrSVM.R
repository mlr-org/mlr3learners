      ...
      super$initialize(
        ...
        param_set = ParamSet$new(
          params = list(
            ...
            ParamDbl$new(id = "cost", default = 1, lower = 0, tags = "train"), # , requires = quote(type == "C-regrication")),
            ParamDbl$new(id = "nu", default = 0.5, tags = "train"), # , requires = quote(type == "nu-regression")),
            ...
            ParamDbl$new(id = "epsilon", lower = 0, tags = "train"), # , requires = quote(type == "eps-regression")),
