  ...
  public = list(
    ...
    initialize = function() {
      ps = ps(
        ...
        cost      = p_dbl(0, default = 1, tags = "train", depends = type %in% c("eps-regression", "nu-regression")),
        cross     = p_int(0L, default = 0L, tags = "train"), # tunable = FALSE),
        degree    = p_int(1L, default = 3L, tags = "train", depends = kernel == "polynomial"),
        epsilon   = p_dbl(0, default = 0.1, tags = "train", depends = type == "eps-regression"),
        ...
        nu        = p_dbl(default = 0.5, tags = "train", depends = type == "nu-regression"),
