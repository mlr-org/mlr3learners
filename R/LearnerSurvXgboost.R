...
LearnerSurvXgboost = R6Class("LearnerSurvXgboost",
  ...
  public = list(
    ...
    initialize = function() {
      ...
      ps = ps(
        booster = p_fct(default = "gbtree", levels = c("gbtree", "gblinear", "dart"), tags = "train"),
        watchlist = p_uty(default = NULL, tags = "train"),
        eta = p_dbl(default = 0.3, lower = 0, upper = 1, tags = "train"),
        gamma = p_dbl(default = 0, lower = 0, tags = "train"),
        max_depth = p_int(default = 6L, lower = 0L, tags = "train"),
        min_child_weight = p_dbl(default = 1, lower = 0, tags = "train"),
        subsample = p_dbl(default = 1, lower = 0, upper = 1, tags = "train"),
        colsample_bytree = p_dbl(default = 1, lower = 0, upper = 1, tags = "train"),
        colsample_bylevel = p_dbl(default = 1, lower = 0, upper = 1, tags = "train"),
        colsample_bynode = p_dbl(default = 1, lower = 0, upper = 1, tags = "train"),
        num_parallel_tree = p_int(default = 1L, lower = 1L, tags = "train"),
        ...
        aft_loss_distribution = p_fct(default = "normal", levels = c("normal", "logistic", "extreme"), tags = "train"),
        aft_loss_distribution_scale = p_dbl(tags = "train"),
        objective = p_fct(default = "survival:cox", levels = c("survival:cox", "survival:aft"), tags = c("train", "predict")),
        ...
        monotone_constraints = p_int(default = 0L, lower = -1L, upper = 1L, tags = "train"),
        tweedie_variance_power = p_dbl(lower = 1, upper = 2, default = 1.5, tags = "train"),
        nthread = p_int(lower = 1L, default = 1L, tags = c("train", "threads")),
        nrounds = p_int(lower = 1L, tags = "train"),
        ...
        save_period = p_int(lower = 0L, tags = "train"),
