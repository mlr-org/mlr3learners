...
package on GitHub. Request additional learners over there.

👉 [Table of all learners](https://mlr-org.com/learners.html)
...
If you also want to install all packages of the connected learners, set
`dependencies = TRUE`:
